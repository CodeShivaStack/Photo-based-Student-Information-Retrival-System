...
class student_info:
    ...
    #class student Academic information
        ...
        save_btn=Button(btn_frame,text="Save",command=self.add_data,width="27",font=("Georgia",13,"bold"),bg="blue",fg="white")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text="Upadte",command=self.update_data,width="27",font=("Georgia",13,"bold"),bg="blue",fg="white")
        update_btn.grid(row=0,column=1)

        delete_btn=Button(btn_frame,text="Delete",command=self.delete_data,width="27",font=("Georgia",13,"bold"),bg="blue",fg="white")
    ...
    def update_and_save_picture(self):
        ...
        query = "SELECT photo FROM student WHERE id = %s"
