...
class Sstudent_info:
    def __init__(self,master,student_id):
        ...
        # right_label frame
        r_frame=LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="Your Details",font=("times new roman",15,"bold"))
        ...
        table_frame.place(x=5,y=145,width=705,height=390  )
...
###     #studentId
        ...
        studentId_entry=ttk.Entry(ClassStudent_frame,textvariable=self.var_id,width=18,font=("times new roman",13,"bold"), state='readonly')
        ...
        if self.data_check():
            self.get_first_row_data()

            #Buttons_frame
            btn_frame=LabelFrame(ClassStudent_frame,bd=2,bg="white",relief=RIDGE)
            btn_frame.place(x=0,y=200,width=715,height=35)

            save_btn=Button(btn_frame,command=self.update_data,text="Save",width="23",font=("times new roman",13,"bold"),bg="blue",fg="white")
            save_btn.grid(row=0,column=0)

            update_btn=Button(btn_frame,command=self.update_data,text="Upadte",width="23",font=("times new roman",13,"bold"),bg="blue",fg="white")
            update_btn.grid(row=0,column=1)

            delete_btn=Button(btn_frame,command=self.delete_data,text="Delete",width="23",font=("times new roman",13,"bold"),bg="blue",fg="white")
            ...
            takePhoto_btn=Button(btn_frame1,text="Take Photo",command=self.upload_and_save_picture,width="35",font=("times new roman",13,"bold"),bg="blue",fg="white")
            takePhoto_btn.grid(row=0,column=0)
...
#=========Function to fetch get_first_row_data===========
    def get_first_row_data(self, event=""):
        cursor_focus = self.student_table.get_children()[0]
        content = self.student_table.item(cursor_focus)
        data = content["values"]

        # Populate entry widgets with the first row data
